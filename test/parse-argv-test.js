...
describe('parseArgv()', function() {
  ...
  describe('tags', function() {
    it('defaults to ["LTtestem", "test"]', function() {
      var result = _parseArgv([]);
      expect(result.tags).to.deep.equal(['LTtestem', 'test']);
    });
  ...
  describe('sessionName', function() {
    it('defaults to "LTtestem tests"', function() {
      var result = _parseArgv([]);
      expect(result.sessionName).to.equal('LTtestem tests');
    });

/**
 * JavaScript tests integration with lambdatest
 * https://lambdatest.com/docs/
 */
var webdriver = require('wd');
var Bluebird = require('bluebird');

module.exports = function(desired, auth, url) {
  if (desired.platformName === 'Android' || desired.platformName === 'iOS' ){
    var browser = webdriver.remote("mobile-hub.lambdatest.com", 80, auth.username, auth.accessKey);
  }else{
    var browser = webdriver.remote("hub.lambdatest.com", 80, auth.username, auth.accessKey);
  }
